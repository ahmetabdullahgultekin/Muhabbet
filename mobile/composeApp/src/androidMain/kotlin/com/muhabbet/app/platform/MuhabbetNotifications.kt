...
internal object MuhabbetNotifications {
    ...
    fun summaryNotificationId(conversationId: String?): Int = "summary_$conversationId".hashCode()

    fun groupKey(conversationId: String?): String = "$GROUP_KEY_PREFIX$conversationId"
